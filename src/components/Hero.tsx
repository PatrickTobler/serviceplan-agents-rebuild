              ...
              <div className="hero-content">
                <div className="hero-text-wrap">
                  <div className="margin-bottom margin-large">
                    <h1>{tt.heading} <br />{tt.headingLine2} <br /><span style={{ fontFamily: 'var(--_serviceplan-styles---regular)', fontWeight: 'normal' }}>{tt.headingLine3}{tt.headingLine4 && <><br />{tt.headingLine4}</>}</span></h1>
                  </div>
